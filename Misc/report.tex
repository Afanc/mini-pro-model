...
\section{The Model}
	...
	With unequal periods, the limit cycles of both cells aren't in phase and form these '8' patterns. The box that appears directly gives us the maximum values of $X_1$ and $X_2$
