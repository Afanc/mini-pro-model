...
\twocolumn[{
   ...
   \begin{figure*}
	...
	\end{subfigure}
	~ 
	\caption{The Coupling Constant $K$ has an impact on the synchronisation of the population. \\
	We observe that $K> 0.5$ \red{or high ?} has a disastrous effect on both cells cycles. The reason for this is that the positive feedback loop has high sensitivity and tends to overload concentrations of $Z_i$ which in turn inhibit any production of $X_i$.}
    \end{figure*}
