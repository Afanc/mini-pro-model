...
In C_2_gif_1 until C_2_gif_6 we see the evolution of the complexity of our system. The titles in the .gif files give the indication as to what part of the model was added. A is the reference to the correlation matrix between the cells. Lambda refers to the multiplier of the period. N is the number of cells 
