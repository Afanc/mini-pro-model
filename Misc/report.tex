...
\twocolumn[{
    \centering
    \Large{\textbf{Part A - One-cell Model}}
}]
	...
	\begin{subfigure}[b]{0.5\textwidth}
	    ...
	    The gene $X$ codes for protein $Y$ which, in turn, activates transcriptional inhibitor $Z$. The resulting model behaves as a three-variable oscillator. \red{and then shit happens TODO}
	    }
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.5\textwidth}
